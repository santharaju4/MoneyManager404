...
class MoneyManager extends Component {
  ...
  onAddButton = event => {
    ...
    const eachOptions = transactionTypeOptions.find(
      eachOption => eachOption.optionId === optionId,
    )

    const {displayText} = eachOptions
    ...
    this.setState(prevState => ({
      transactionsList: [...prevState.transactionsList, newOption],
      titleInput: '',
      amountInput: '',
      optionId: transactionTypeOptions[0].optionId,
    }))
    ...
    return (
      <div className="app-container">
        ...
        <div className="transaction-details">
          <form className="transaction-form" onSubmit={this.onAddButton}>
